...
import logging
import json
from jwtauth.model import UserSchema, USR_DATABASE, Role
...
if __name__ == "__main__":
    ...
    items = [
        UserSchema(id='16fd2706-8baf-433b-82eb-8c7fada847da', fullname="User1 Name1",
                   email="user1@example.com", role=Role.ADMIN,
                   password="$pbkdf2-sha256$29000$l/J.b62VkjIGwNhbi9H6Pw$/8knmcVTwoMX2tG.veabSejUgn4lTfdvsz8Wj3ViDZY"),
        UserSchema(id='3720f69a-a72f-47b4-8caf-46ff0b83523e', fullname="User2 Name2",
                   email="user2@example.com", role=Role.SUPER,
                   password="$pbkdf2-sha256$29000$mHNuDcHY23vPGSOklPJ.Lw$DZS6OPDk7DRRqmDc6QSqAYmq2IlBfTzmoXc2zfJsGQM"),
        UserSchema(id='1b702cc8-4e71-4685-bc48-df62a8205fd7', fullname="User3 Name3",
                   email="user3@example.com", role=Role.OPS,
                   password="$pbkdf2-sha256$29000$OIfQuhdCiHGOMUaIca51Lg$Mcf/TU6lz4pyMXrHJdhq06GSifoaRz8TGn13pIMPEmY"),
        UserSchema(id='ee96aaeb-9f79-44d2-8559-cd5941ed3b29', fullname="User4 Name4",
                   email="user4@example.com", role=Role.OPS,
                   password="$pbkdf2-sha256$29000$QmgNIQQg5HyPsZby/t9bCw$mvvh8ldioPcedhUUoaXTTWUHdBkt89mgWmJvApkAT88"),
    ]
